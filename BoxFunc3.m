function BoxFunc3 (robot,vert,item)
...
ItemFuncMove(robot,OriginalQ,QFunc3,100, vert, item,0);

ItemFuncMove(robot,QFunc3,QItem3,300, vert, item,0);
...
ItemFuncMove(robot, QItem3, QMain3, 100, vert, item,1);

ItemFuncMove(robot, QMain3,QMain, 300, vert, item,1);

ItemFuncMove(robot, QMain,QDest, 50, vert, item,1);
...
start_point = [0, -0.8502, 0.9513]
end_point = [0, -1.041, 0.6013]
