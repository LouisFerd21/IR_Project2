function BoxBack1 (robot,vert,item,n,vertItem,item2)

OriginalQ = [0         0   -0.8727         0    0.7272         0];
QFunc1 = [0   -0.4581    0.0727         0   -1.7453         0];
QItem1 = [0   -0.4398    0.2793         0   -1.7453         0];
QMain1 = [0.0000    0.4581   -0.5091         0   -1.6639         0];
...
LastLoc= transl(BoxesL(1,1),BoxesL(1,2),BoxesL(1,3));
...
switch n
    case 1
        ...
        ItemFuncMove(robot,QMain, QMain1, 100, vert, item,1);

        ItemFuncMove(robot, QMain1, QItem1, 100, vert, item,1);
        ...
        ItemFuncMove(robot,QItem1,QFunc1,100,vert, item,0);
        
        ItemFuncMove(robot,QFunc1,OriginalQ,100,vert, item,0);
    ...
    case 2
        ...
        ItemFuncMove(robot,QMain, QMain1, 100, vert, item,3, vertItem, item2);
        
        ItemFuncMove(robot, QMain1, QItem1, 100, vert, item,3, vertItem, item2);
