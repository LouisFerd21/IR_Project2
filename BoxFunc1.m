function BoxFunc1 (robot,vert,item)
...
ItemFuncMove(robot,OriginalQ,QFunc1,100, vert, item,0);

ItemFuncMove(robot,QFunc1,QItem1,100, vert, item,0);
...
ItemFuncMove(robot, QItem1, QMain1, 100, vert, item,1);

ItemFuncMove(robot, QMain1,QMain, 100, vert, item,1);
