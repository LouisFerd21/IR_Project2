function BoxBack3 (robot,vert,item,n,vertItem,item2)

OriginalQ = [0         0   -0.8727         0    0.7272         0];

QFunc3 = [3.1416   -0.4581    0.0727         0   -1.7453         0];

QItem3 = [3.1416   -0.4398    0.2793         0   -1.7453         0];

QMain3 = [3.1416    0.4581   -0.5091         0   -1.6639         0];
...
LastLoc= transl(BoxesL(3,1),BoxesL(3,2),BoxesL(3,3));
...
switch n
    case 1
        ...
        ItemFuncMove(robot,QMain, QMain3, 300, vert, item,1);
        
        ItemFuncMove(robot, QMain3, QItem3, 100, vert, item,1);
        ...
        ItemFuncMove(robot,QItem3,QFunc3,300,vert, item,0);
        
        ItemFuncMove(robot,QFunc3,OriginalQ,100,vert, item,0);
    ...
    case 2
        ...
        ItemFuncMove(robot,QMain, QMain3, 100, vert, item,3, vertItem, item2);
        
        ItemFuncMove(robot, QMain3, QItem3, 100, vert, item,3, vertItem, item2);
